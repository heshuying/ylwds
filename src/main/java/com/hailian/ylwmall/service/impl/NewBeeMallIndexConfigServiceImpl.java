...
import com.hailian.ylwmall.controller.vo.NewBeeMallIndexConfigGoodsVO;
import com.hailian.ylwmall.service.NewBeeMallIndexConfigService;
...
public class NewBeeMallIndexConfigServiceImpl implements NewBeeMallIndexConfigService {
    ...
    public List<NewBeeMallIndexConfigGoodsVO> getConfigGoodsesForIndex(int configType, int number) {
        ...
        if (!CollectionUtils.isEmpty(indexConfigs)) {
            ...
            List<TbGoodsInfo> newBeeMallGoods = goodsMapper.selectByPrimaryKeys(goodsIds);
